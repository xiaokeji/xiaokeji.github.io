...
module.exports = AV.Object.extend('_Conversation', /** @lends AV.Conversation.prototype */{
   ...
   *     realtime SDK's Message object. See more: {@link https://leancloud.cn/docs/realtime_guide-js.html#æ¶ˆæ¯}
   ...
   * @param {Object} [options.pushData] Push data to this message. See more: {@link https://url.leanapp.cn/pushData æŽ¨é€æ¶ˆæ¯å†…å®¹}
...
module.exports = function (AV) {
  ...
  AV.File = function (name, data, mimeType) {
    ...
    this.attributes = {
      ...
      url: '',
      metaData: {},
      // ç”¨æ¥å­˜å‚¨è½¬æ¢åŽè¦ä¸Šä¼ çš„ base64 String
      base64: ''
    };
  ...
  _.extend(AV.File.prototype, /** @lends AV.File.prototype */{
      ...
      var set = function set(attrName, value) {
        switch (attrName) {
          ...
          case 'metaData':
            ...
            break;
          default:
            // File å¹¶éžä¸€ä¸ª AVObjectï¼Œä¸èƒ½å®Œå…¨è‡ªå®šä¹‰å…¶ä»–å±žæ€§ï¼Œæ‰€ä»¥åªèƒ½éƒ½æ”¾åœ¨ metaData ä¸Šé¢
    ...
    **/
    ...
    /**
     * å¦‚æžœæ–‡ä»¶æ˜¯å›¾ç‰‡ï¼ŒèŽ·å–å›¾ç‰‡çš„ç¼©ç•¥å›¾URLã€‚å¯ä»¥ä¼ å…¥å®½åº¦ã€é«˜åº¦ã€è´¨é‡ã€æ ¼å¼ç­‰å‚æ•°ã€‚
     * @return {String} ç¼©ç•¥å›¾URL
     * @param {Number} width å®½åº¦ï¼Œå•ä½ï¼šåƒç´ 
     * @param {Number} heigth é«˜åº¦ï¼Œå•ä½ï¼šåƒç´ 
     * @param {Number} quality è´¨é‡ï¼Œ1-100çš„æ•°å­—ï¼Œé»˜è®¤100
     * @param {Number} scaleToFit æ˜¯å¦å°†å›¾ç‰‡è‡ªé€‚åº”å¤§å°ã€‚é»˜è®¤ä¸ºtrueã€‚
     * @param {String} fmt æ ¼å¼ï¼Œé»˜è®¤ä¸ºpngï¼Œä¹Ÿå¯ä»¥ä¸ºjpeg,gifç­‰æ ¼å¼ã€‚
     */
    ...
    */
     ...
     * @param {Object} [options]
     * @param {UploadProgressCallback} [options.onprogress] æ–‡ä»¶ä¸Šä¼ è¿›åº¦ï¼Œåœ¨ Node.js ä¸­æ— æ•ˆï¼Œå›žè°ƒå‚æ•°è¯´æ˜Žè¯¦è§ {@link UploadProgressCallback}ã€‚
...
module.exports = function (AV) {
  /**
   * åŒ…å«äº†ä½¿ç”¨äº† LeanCloud
   *  <a href='/docs/leaninsight_guide.html'>ç¦»çº¿æ•°æ®åˆ†æžåŠŸèƒ½</a>çš„å‡½æ•°ã€‚
   * <p><strong><em>
   *   ä»…åœ¨äº‘å¼•æ“Žè¿è¡ŒçŽ¯å¢ƒä¸‹æœ‰æ•ˆã€‚
   * </em></strong></p>
   * @namespace
   */
  ...
  _.extend(AV.Insight, /** @lends AV.Insight */{
    ...
    /**
     * å¼€å§‹ä¸€ä¸ª Insight ä»»åŠ¡ã€‚ç»“æžœé‡Œå°†è¿”å›ž Job idï¼Œä½ å¯ä»¥æ‹¿å¾—åˆ°çš„ id ä½¿ç”¨
     * AV.Insight.JobQuery æŸ¥è¯¢ä»»åŠ¡çŠ¶æ€å’Œç»“æžœã€‚
     * @param {Object} jobConfig ä»»åŠ¡é…ç½®çš„ JSON å¯¹è±¡ï¼Œä¾‹å¦‚ï¼š<code><pre>
     ...
     *                   }
     *                  </pre></code>
     *               sql æŒ‡å®šä»»åŠ¡æ‰§è¡Œçš„ SQL è¯­å¥ï¼Œ saveAsï¼ˆå¯é€‰ï¼‰ æŒ‡å®šå°†ç»“æžœä¿å­˜åœ¨å“ªå¼ è¡¨é‡Œï¼Œlimit æœ€å¤§ 1000ã€‚
     * @param {AuthOptions} [options]
     * @return {Promise} A promise that will be resolved with the result
     * of the function.
     */
    ...
    /**
     * ç›‘å¬ Insight ä»»åŠ¡äº‹ä»¶ï¼Œç›®å‰ä»…æ”¯æŒ end äº‹ä»¶ï¼Œè¡¨ç¤ºä»»åŠ¡å®Œæˆã€‚
     *  <p><strong><em>
     *     ä»…åœ¨äº‘å¼•æ“Žè¿è¡ŒçŽ¯å¢ƒä¸‹æœ‰æ•ˆã€‚
     *  </em></strong></p>
     * @param {String} event ç›‘å¬çš„äº‹ä»¶ï¼Œç›®å‰ä»…æ”¯æŒ 'end' ï¼Œè¡¨ç¤ºä»»åŠ¡å®Œæˆ
     * @param {Function} ç›‘å¬å›žè°ƒå‡½æ•°ï¼ŒæŽ¥æ”¶ (err, id) ä¸¤ä¸ªå‚æ•°ï¼Œerr è¡¨ç¤ºé”™è¯¯ä¿¡æ¯ï¼Œ
     *                   id è¡¨ç¤ºä»»åŠ¡ idã€‚æŽ¥ä¸‹æ¥ä½ å¯ä»¥æ‹¿è¿™ä¸ª id ä½¿ç”¨AV.Insight.JobQuery æŸ¥è¯¢ä»»åŠ¡çŠ¶æ€å’Œç»“æžœã€‚
     *
     */
  ...
  /**
   * åˆ›å»ºä¸€ä¸ªå¯¹è±¡ï¼Œç”¨äºŽæŸ¥è¯¢ Insight ä»»åŠ¡çŠ¶æ€å’Œç»“æžœã€‚
   * @class
  ...
  _.extend(AV.Insight.JobQuery.prototype, /** @lends AV.Insight.JobQuery.prototype */{
    ...
    /**
     * æŸ¥è¯¢ä»»åŠ¡çŠ¶æ€å’Œç»“æžœï¼Œä»»åŠ¡ç»“æžœä¸ºä¸€ä¸ª JSON å¯¹è±¡ï¼ŒåŒ…æ‹¬ status è¡¨ç¤ºä»»åŠ¡çŠ¶æ€ï¼Œ totalCount è¡¨ç¤ºæ€»æ•°ï¼Œ
     * results æ•°ç»„è¡¨ç¤ºä»»åŠ¡ç»“æžœæ•°ç»„ï¼ŒpreviewCount è¡¨ç¤ºå¯ä»¥è¿”å›žçš„ç»“æžœæ€»æ•°ï¼Œä»»åŠ¡çš„å¼€å§‹å’Œæˆªæ­¢æ—¶é—´
     * startTimeã€endTime ç­‰ä¿¡æ¯ã€‚
     *
     * @param {AuthOptions} [options]
     * @return {Promise} A promise that will be resolved with the result
     * of the function.
...
var getWeappLoginCode = function getWeappLoginCode() {
  ...
  return new Promise(function (resolve, reject) {
    wx.login({
      ...
      fail: function fail() {
        return reject(new Error('wx.login å¤±è´¥'));
      }
    });
  });
};
...
module.exports = function (AV) {
  ...
  AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
    ...
    /**
     * å°†ç”¨æˆ·ä¸Žå°ç¨‹åºç”¨æˆ·è¿›è¡Œå…³è”ã€‚é€‚ç”¨äºŽä¸ºå·²ç»åœ¨ç”¨æˆ·ç³»ç»Ÿä¸­å­˜åœ¨çš„ç”¨æˆ·å…³è”å½“å‰ä½¿ç”¨å°ç¨‹åºçš„å¾®ä¿¡å¸å·ã€‚
     * ä»…åœ¨å°ç¨‹åºä¸­å¯ç”¨ã€‚
     *
    ...
    _unlinkFrom: function _unlinkFrom(provider) {
      console.warn('DEPRECATED: User#_unlinkFrom å·²åºŸå¼ƒï¼Œè¯·ä½¿ç”¨ User#dissociateAuthData ä»£æ›¿');
     ...
     * @deprecated å¦‚æžœè¦åˆ¤æ–­å½“å‰ç”¨æˆ·çš„ç™»å½•çŠ¶æ€æ˜¯å¦æœ‰æ•ˆï¼Œè¯·ä½¿ç”¨ currentUser.isAuthenticated().then()ï¼Œ
     * å¦‚æžœè¦åˆ¤æ–­è¯¥ç”¨æˆ·æ˜¯å¦æ˜¯å½“å‰ç™»å½•ç”¨æˆ·ï¼Œè¯·ä½¿ç”¨ user.id === currentUser.id
     * @return (Boolean) whether this user is the current user and is logged in.
     */
    authenticated: function authenticated() {
      console.warn('DEPRECATED: å¦‚æžœè¦åˆ¤æ–­å½“å‰ç”¨æˆ·çš„ç™»å½•çŠ¶æ€æ˜¯å¦æœ‰æ•ˆï¼Œè¯·ä½¿ç”¨ currentUser.isAuthenticated().then()ï¼Œå¦‚æžœè¦åˆ¤æ–­è¯¥ç”¨æˆ·æ˜¯å¦æ˜¯å½“å‰ç™»å½•ç”¨æˆ·ï¼Œè¯·ä½¿ç”¨ user.id === currentUser.idã€‚');
      return !!this._sessionToken && !AV._config.disableCurrentUser && AV.User.current() && AV.User.current().id === this.id;
    },

    /**
     * æ£€æŸ¥è¯¥ç”¨æˆ·çš„ç™»å½•çŠ¶æ€æ˜¯å¦æœ‰æ•ˆï¼Œè¯·æ³¨æ„è¯¥æ–¹æ³•ä¼šæ ¡éªŒ sessionToken çš„æœ‰æ•ˆæ€§ï¼Œæ˜¯ä¸ªå¼‚æ­¥æ–¹æ³•ã€‚
     *
     * @since 2.0.0
     ...
     *   //console.error("error: ", error);
     * });
     * @see {@link https://leancloud.cn/docs/js_guide.html#ç»‘å®šç¬¬ä¸‰æ–¹å¹³å°è´¦æˆ·}
     */
    ...
    /**
     * ä½¿ç”¨å½“å‰ä½¿ç”¨å°ç¨‹åºçš„å¾®ä¿¡ç”¨æˆ·èº«ä»½æ³¨å†Œæˆ–ç™»å½•ï¼ŒæˆåŠŸåŽç”¨æˆ·çš„ session ä¼šåœ¨è®¾å¤‡ä¸ŠæŒä¹…åŒ–ä¿å­˜ï¼Œä¹‹åŽå¯ä»¥ä½¿ç”¨ AV.User.current() èŽ·å–å½“å‰ç™»å½•ç”¨æˆ·ã€‚
     * ä»…åœ¨å°ç¨‹åºä¸­å¯ç”¨ã€‚
     *
     * @since 2.0.0
     * @return {AV.User}
    ...
    associateWithAuthData: function associateWithAuthData(userObj, platform, authData) {
      console.warn('DEPRECATED: User.associateWithAuthData å·²åºŸå¼ƒï¼Œè¯·ä½¿ç”¨ User#dissociateAuthData ä»£æ›¿');
...
module.exports = function upload(uploadInfo, data, file) {
  ...
  file.id = uploadInfo.objectId;
  return new Promise(function (resolve, reject) {
    // æµ·å¤–èŠ‚ç‚¹ï¼Œé’ˆå¯¹ S3 æ‰ä¼šè¿”å›ž upload_url
